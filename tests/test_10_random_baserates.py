...
logs.logger.error(f'{__name__} started')
...
def test_main(devices):
    ...
    for pam in pam_pull:
        ...
        logs.logger.info('Baserate 20 was setted!')
        print('__________________________________123123123_______________________________')
        time.sleep(10)
